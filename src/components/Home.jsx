  ...
  return (
    <div className='flex flex-col lg:flex-row justify-evenly'>
      ...
      <div className='w-full lg:w-2/5 rounded-e-lg mt-5 mb-5 lg:ml-5 bg-slate-700 h-96 lg:h-screen'>
        ...
        <div className='w-3/4 lg:w-3/5 ml-4 lg:mt-24 flex justify-center items-center sm:w-1/4 sm:ml-60 sm:h-24 lg:ml-24 mt-11 bg-white h-48 rounded-lg'>
      <div><img className=' h-full object-contain' src="https://images.pexels.com/photos/242492/pexels-photo-242492.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
 </div>
     </div>
      </div>
    </div>
